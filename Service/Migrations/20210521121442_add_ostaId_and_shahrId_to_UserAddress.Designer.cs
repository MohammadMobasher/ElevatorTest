...
namespace Service.Migrations
{
    ...
    [Migration("20210521121442_add_ostaId_and_shahrId_to_UserAddress")]
    partial class add_ostaId_and_shahrId_to_UserAddress
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataLayer.Entities.Bank.UsersPayment", b =>
                {
                    ...
                    b.Property<bool?>("IsCallBackRecive");
            ...
            modelBuilder.Entity("DataLayer.Entities.Log", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DataLayer.Entities.ProductPackage", b =>
                {
                    ...
                    b.Property<long>("PackagePrice")
                        .ValueGeneratedOnAddOrUpdate();

                    b.Property<long?>("PackageWithDiscounts")
                        .ValueGeneratedOnAddOrUpdate();
            ...
            modelBuilder.Entity("DataLayer.Entities.ProductPackageDiscount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("ProductPackageDiscount");
                });
            ...
            modelBuilder.Entity("DataLayer.Entities.ProductPackageGroups", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("ProductPackageGroups");
                });
            ...
            modelBuilder.Entity("DataLayer.Entities.ShopOrder", b =>
                {
                    ...
                    b.Property<bool>("IsOnlinePay");

                    b.Property<bool>("IsSpecialInvoice");
                    ...
                    b.Property<long?>("TransferProductPrice");
            ...
            modelBuilder.Entity("DataLayer.Entities.ShopOrderDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DataLayer.Entities.ShopOrderPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DataLayer.Entities.ShopOrderStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DataLayer.Entities.ShopProduct", b =>
                {
                    ...
                    b.Property<string>("OrderPriceDiscount");
            ...
            modelBuilder.Entity("DataLayer.Entities.SuggestionsAndComplaint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("SuggestionsAndComplaint");
                });

            modelBuilder.Entity("DataLayer.Entities.Transportation.CarTransport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("TransportSize");

                    b.HasKey("Id");

                    b.ToTable("CarTransport");
                });

            modelBuilder.Entity("DataLayer.Entities.Transportation.TransportationTariff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<double>("ProductSizeFrom");

                    b.Property<double>("ProductSizeTo");

                    b.Property<long>("Tariff");

                    b.Property<int>("TehranAreasFrom");

                    b.Property<int>("TehranAreasTO");

                    b.HasKey("Id");

                    b.HasIndex("CarId");

                    b.ToTable("TransportationTariff");
                });

            modelBuilder.Entity("DataLayer.Entities.TreeInfo.Tree", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DataLayer.Entities.TreeInfo.UserTreeReminded", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<double>("Reminded");
            ...
            modelBuilder.Entity("DataLayer.Entities.Transportation.TransportationTariff", b =>
                {
                    b.HasOne("DataLayer.Entities.Transportation.CarTransport", "CarTransport")
                        .WithMany()
                        .HasForeignKey("CarId");
                });
