...
(function ($) {
    $.fn.imageUploader = function (options) {
        ...
        let createImg = function (src, id, index) {
            let $container = $('<div>', {
            ...
            if (plugin.settings.preloaded.length) {
                ...
                let $preloaded = $('<input>', {
                    type: 'hidden',
                    name: plugin.settings.preloadedInputName + "["+index+"]",
                    value: id
                }).appendTo($container)
            } else {
        ...
        let setPreview = function ($container, files) {
            ...
            $(files).each(function (i, file) {
                ...
                $uploadedContainer.append(createImg(URL.createObjectURL(file), dataTransfer.items.length - 1, i))
            });
